...
const Header = (props) => {
    ...
    const searchPath = query.trim() ? `/searchresults/${query.trim()}` : '/';
                                ...
                                userInfo ? (
                                    <div className="header-dropdown">
                                        ...
                                        <ul className={ dropdown? 'dropdown-content show' : 'dropdown-content'}>
                                            ...
                                            <li>
                                               <Link to="/orderhistory" onClick={() => setDropDown(false)}>Order History</Link> 
                                            </li>
                                            <li>
                            ...
                            <li>
                                <div className="header-dropdown">
                                    ...
                                    <ul className={ secondDropdown? 'dropdown-content show' : 'dropdown-content'}>
                                        ...
                                        <li>
                                           <Link to="/productlist" onClick={() => setSecondDropdown(false)}>Products</Link> 
                                        </li>
